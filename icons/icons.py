...
ICON_CHOICE = [
    ...
    (
        "dog-bitting-a-stick-playing-with-a-man",
        _("dog-bitting-a-stick-playing-with-a-man"),
    ),
    ...
    (
        "dog-puppy-sitting-in-front-of-his-man",
        _("dog-puppy-sitting-in-front-of-his-man"),
    ),
    ...
    (
        "man-carrying-a-dog-with-a-belt-to-walk",
        _("man-carrying-a-dog-with-a-belt-to-walk"),
    ),
    ("man-combing-a-dog", _("man-combing-a-dog")),
    ("man-on-his-knees-to-cuddle-his-dog", _("man-on-his-knees-to-cuddle-his-dog")),
    (
        "man-throwing-a-disc-and-dog-jumping-to-catch-it",
        _("man-throwing-a-disc-and-dog-jumping-to-catch-it"),
    ),
